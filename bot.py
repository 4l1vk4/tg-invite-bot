...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        f"Привет, {first_name}! 🌴✨\n\n"
        f"У тебя есть персональное приглашение на наш праздничный гастро-уикенд!\n\n"
        f"🍽️ Внутри тебя ждёт меню из **5 национальных кухонь**:\n"
        f"1. 🍣 🇯🇵 Японская кухня\n"
        f"2. 🌮 🇲🇽 Мексиканская кухня\n"
        f"3. 🍕 🇮🇹 Итальянская кухня\n"
        f"4. 🪆 🇷🇺 Русская кухня\n"
        f"5. 🥨 🇩🇪 Немецкая кухня\n\n"
